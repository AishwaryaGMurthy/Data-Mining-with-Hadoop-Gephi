...
public class RandomIndegree extends Configured implements Tool 
{static class RandomIndegreeMapper extends Mapper<Text, BytesWritable, Text, Text> {
...
static class RandomIndegreeReducer extends Reducer<Text, Text, Text, Text> {
	...
	public void reduce(Text key, Iterable<Text> values, Context context)throws IOException, InterruptedException {	
		...
		for(String a:toList){
			//The repetion of a particular 'to' address is the indegree value
...
public int run(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
	...
	job.setMapperClass(RandomIndegreeMapper.class);
	job.setReducerClass(RandomIndegreeReducer.class);
...
public static void main(String[] args) throws Exception {
	int exitCode = ToolRunner.run(new RandomIndegree(), args);
