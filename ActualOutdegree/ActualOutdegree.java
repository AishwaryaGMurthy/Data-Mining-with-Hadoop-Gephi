...
public class ActualOutdegree extends Configured implements Tool 
{static class OutdegreeMapper extends Mapper<Text, BytesWritable, Text, Text> {
...
static class OutdegreeReducer extends Reducer<Text, Text, Text, Text> {
	...
	public void reduce(Text key, Iterable<Text> values, Context context)throws IOException, InterruptedException {	
		...
		int m=0; //Total number of edges between all the 'to' and 'from' mail address
		int n=0; //Total number of outdegree nodes
		for (Text t : values) 
		{
...
//value of this mapper class- 'from' mail address with its outdegree 
//the outdegree is split and given as the key to the mapper
//key-outdegree
//value-IntWritable(1)
public static class ActualOutdegreeMapper extends
...
//key-outdegree
//value-number of occurence of the outdegree
public static class ActualOutdegreeReducer extends
...
//	job.setCombinerClass(MailReaderReducer.class);
	...
	job2.setMapperClass(ActualOutdegreeMapper.class);
	job2.setReducerClass(ActualOutdegreeReducer.class);
	boolean status = job2.waitForCompletion(true);
	return status ? 0 : 1;
}

public static void main(String[] args) throws Exception {
	int exitCode = ToolRunner.run(new ActualOutdegree(), args);
